...
const team = [
  { initials: "SS", name: "Er. Sachin Sir", role: "Math & Physics Faculty", bio: "B.Tech (IT) — 9 years of mentoring students through algebra, calculus and mechanics.", color: "from-blue-500 to-cyan-400" },
  { initials: "RS", name: "Er. Ramesh Sir", role: "Computer Science Mentor", bio: "B.Tech (IT), M.A., B.Ed. Specialisation in programming and algorithms.", color: "from-indigo-500 to-blue-400" },
  { initials: "AS", name: "Mr. Ansh Sir", role: "History & Geography", bio: "B.A. — focused on concept clarity, frequent tests and engaging discussions.", color: "from-cyan-500 to-teal-400" },
  { initials: "SM", name: "Ms. Shalu Ma'am", role: "PRT (Hindi & General)", bio: "CTET, UPTET, BiharTET, NET (Education) — dedicated to nurturing young minds.", color: "from-sky-500 to-blue-300" },
  { initials: "SH", name: "Ms. Shandhya Ma'am", role: "Counsellor (Psychology)", bio: "PGT (Psychology) and Govt. Teacher — supporting student well-being.", color: "from-blue-600 to-indigo-400" },
];
